        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ParkAreaId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingSlots_ParkAreas_ParkAreaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingLogs_ParkingSlots_ParkingSlotId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingLogs_ParkingSlotId",
                table: "ParkingLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingSlots_ParkAreaId",
                table: "ParkingSlots",
                column: "ParkAreaId");
